...
cat business.out | sed 's/&#39;/-/g; s/&amp;/-/g; s/(/-/g; s/)/-/g; s/ /-/g; s/--*/-/g; s/&quot;//g; s/&#233;//g; s/&#241;//g; s/&#174;//g; s/&#246;//g; s/&#237;/i/g; s/&#225;/a/g; s/(-)+$//' | sed -E 's/(-)+$//' > context.out

cat context.out | sed 's/\./-/g; s/?//g; s/!//g; s/\//-/g; s/#//g; s/,//g' > business-urls.out
